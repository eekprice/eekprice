  ...
  return (
    <motion.div className="flex flex-col w-full items-start px-4" variants={itemVariants}>
      <div className="m-4 leading-loose">
        <p className="text-lg font-merriweather font-normal text-surface-foreground300-light dark:text-surface-foreground300-dark leading-loose">
        ...
        <p className="text-lg font-merriweather font-normal mt-4 text-surface-foreground300-light dark:text-surface-foreground300-dark leading-loose">
